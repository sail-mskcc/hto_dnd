...
def test_gmm_demux(mock_hto_data):
    ...
    assert accuracy > .6, f"Classification accuracy appears random, got {accuracy:.2f} instead of > 0.6. Might be fixed after re-running the demultiplexing, due to potential seeding issues."
