...
def ground_truth_prediction_100():
    ...
    ground_truth = pd.Series(["a", "a", "a", "a", "b", "b", "b", "b", "low_quality", "negative", "doublet"])
    prediction = pd.Series(["a", "a", "a", "a", "b", "b", "b", "b", "low_quality", "negative", "doublet"])
...
def ground_truth_prediction_50():
    ...
    ground_truth = pd.Series(["a", "a", "a", "a", "b", "b", "b", "b", "low_quality", "negative", "doublet"])
    prediction = pd.Series(["a", "a", "a", "a", "c", "c", "c", "c", "low_quality", "negative", "doublet"])
    return ground_truth, prediction
...
def test_srr_fail(ground_truth_prediction_50):
    ...
    ground_truth, prediction = ground_truth_prediction_50
    srr = metrics.srr(ground_truth, prediction, non_singlet_substring=["someotherstuff"])
    assert srr != 0.5
